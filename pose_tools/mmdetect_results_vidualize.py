...
linestyle = ['--', '-.', '-']
loss_metrics = ['loss', 'loss_bbox', 'loss_cls', 'loss_rpn_cls', 'loss_rpn_bbox']
acc_metrics = ['acc']
ap_metrics = ['coco/bbox_mAP', 'coco/bbox_mAP_50', 'coco/bbox_mAP_75', 'coco/bbox_mAP_s', 'coco/bbox_mAP_m', 'coco/bbox_mAP_l']
test_metrics = ['pascal_voc/mAP', 'pascal_voc/AP50']
